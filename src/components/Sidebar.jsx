...
const Sidebar = () => {
  return (
    <div className="w-64 h-screen bg-white flex flex-col fixed left-0 top-0 z-50">
      {/* Logo */}
      <div className="p-6 flex items-center gap-2.5">
        ...
        <h1 className="text-xl font-bold text-primary-blue tracking-tight">Schola</h1>
      </div>
      ...
      {/* Promo Card precisely as seen in the image */}
      ...
      <div className="px-8 pb-8">
        <button className="flex items-center gap-3 text-sidebar-text hover:text-red-500 transition-all group w-full">
