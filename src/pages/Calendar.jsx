...
const calendarEvents = [
  ...
  { id: 8, title: 'Parent-Teacher Meeting (Grade 7 & 8)', category: 'Events', day: 12, time: '02:00 PM - 04:00 PM', color: 'bg-[#bae6fd] text-[#0ea5e9] rounded-lg px-2 py-1 border border-[#0ea5e9]/20' },
  { id: 9, title: 'History Exam', category: 'Academic', day: 14, time: '09:00 AM - 11:00 AM', color: 'bg-primary-pink/10 text-primary-pink rounded-lg px-2 py-1 border border-primary-pink/20' },
  { id: 10, title: 'School Choir Rehearsal', category: 'Events', day: 15, time: '10:00 AM - 12:00 PM', color: 'bg-[#bae6fd] text-[#0ea5e9] rounded-lg px-2 py-1 border border-[#0ea5e9]/20' },
  { id: 11, title: 'Monthly Staff Appraisal', category: 'Administration', day: 20, time: '02:00 PM - 04:00 PM', color: 'bg-primary-pink/10 text-primary-pink rounded-lg px-2 py-1 border border-primary-pink/20' },
  { id: 12, title: 'Grade 9 Fee Payment Deadline', category: 'Finance', day: 23, time: 'All Day', color: 'bg-[#1a365d] text-white rounded-lg px-2 py-1' },
